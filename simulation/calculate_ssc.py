...
if __name__ == "__main__":
    ...
    #     s = scc.genome_scc(
    #         sim_contact_mat, hic_contact_mat, BIN_SIZE, chrom_lengths, MAX_DIST, 5
    #     )

    #     print(f"SCC for HiC/Sim Cell {n_cell}: {s:.3}\n")
    ...
    # h = scc.h_train(
    #     sim_contact_mat1, sim_contact_mat2, BIN_SIZE, chroms_lengths, MAX_DIST, h_max=50
    # )
    ...
    for n, n_cell in enumerate(range(1, 9)):
        hic_mat = make_hic_contact_matrix(n_cell)
        sim_mat = load_sim_contact_matrix(n_cell)
