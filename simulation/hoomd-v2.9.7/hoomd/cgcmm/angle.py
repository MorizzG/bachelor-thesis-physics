    ...
    def set_coeff(self, angle_type, k, t0, exponents, epsilon, sigma):
        ...
        if (exponents == 124) or (exponents == "lj12_4") or (exponents == "LJ12-4"):
            ...
            self.cpp_force.setParams(
                hoomd.context.current.system_definition.getAngleData().getTypeByName(angle_type),
                k,
                t0,
                cg_type,
                epsilon,
            ...
            raise RuntimeError(
                "Unknown exponent type.  Must be 'none' or one of MN, ljM_N, LJM-N with M/N in 12/4, 9/6, or 12/6"
            )
