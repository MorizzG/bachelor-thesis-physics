...
from . import GTAR, copy, isZip64

parser = argparse.ArgumentParser(description="Command-line zip archive fixer")
parser.add_argument("input", help="Input zip file to read")
parser.add_argument("-o", "--output", default="fixed.zip", help="Output location for fixed zip archive")
