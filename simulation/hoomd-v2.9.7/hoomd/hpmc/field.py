...
from hoomd.hpmc import _hpmc, integrate
...
class frenkel_ladd_energy(_compute):
    ...
    def __init__(self, mc, ln_gamma, q_factor, r0, q0, drift_period, symmetry=[]):
        import math
