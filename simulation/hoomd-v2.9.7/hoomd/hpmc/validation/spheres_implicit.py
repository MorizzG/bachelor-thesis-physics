...
eta_p_ref[(0.01, 1.0)] = (0.926884, 0.0000312035)
...
eta_p_ref[(0.01, 2.0)] = (1.92188, 0.000436138)
...
eta_p_ref[(0.05, 1.0)] = (0.712581, 0.000143215)
...
eta_p_ref[(0.05, 2.0)] = (1.61347, 0.000118301)
...
eta_p_ref[(0.1, 1.0)] = (0.491528, 0.000211232)
...
eta_p_ref[(0.1, 2.0)] = (1.24626, 0.00085732)
...
eta_p_ref[(0.2, 1.0)] = (0.141602, 0.000141207)
...
eta_p_ref[(0.2, 2.0)] = (0.594751, 0.00061228)
...
eta_p_ref[(0.3, 1.0)] = (0.0100912, 3.00293e-6)
...
eta_p_ref[(0.3, 2.0)] = (0.0387704, 0.000167702)
...
class implicit_test(unittest.TestCase):
    ...
    def test_measure_etap_new(self):
        ...
        log = analyze.log(
            filename=None,
            quantities=["hpmc_overlap_count", "volume", "hpmc_free_volume", "hpmc_fugacity"],
            overwrite=True,
            period=1000,
        )
