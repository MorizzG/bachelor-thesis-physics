...
class test_constrain_rigid(unittest.TestCase):
    ...
    def test_npt(self):
        ...
        log = analyze.log(
            filename=None,
            quantities=["potential_energy", "kinetic_energy", "npt_thermostat_energy", "npt_barostat_energy", "volume"],
            period=10,
        )
        ...
        E0 = (
            ...
            + log.query("npt_thermostat_energy")
            + log.query("npt_barostat_energy")
            + P * log.query("volume")
        )
        run(50)
        E1 = (
    ...
    def test_reinit(self):
        ...
        rigid.set_param(
            ...
            positions=[(0, 0, -len_cyl / 2), (0, 0, len_cyl / 2)],
            diameters=[1, 2],
            charges=[-1, 1],
        )
        rigid.set_param(
...
class test_constrain_rigid_nonrigid(unittest.TestCase):
    ...
    def test_rigid_nonrigid(self):
        ...
        rigid = md.constrain.rigid()
        rigid.set_param("A", types=["A_const"] * 2, positions=[(-0.5, 0, 0), (0.5, 0, 0)])
