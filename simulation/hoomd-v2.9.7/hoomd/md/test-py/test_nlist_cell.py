...
# md.nlist.cell testing
class nlist_cell_tests(unittest.TestCase):
    def setUp(self):
        print
        init.create_lattice(lattice.sc(a=2.1878096788957757), n=[10, 10, 10])
    ...
    def test_reset_exclusions_nowork(self):
        self.assertRaises(RuntimeError, self.nl.reset_exclusions, exclusions=["bond", "angle", "invalid"])
