...
class update_rescale_temp_tests(unittest.TestCase):
    def setUp(self):
        print
        self.system = init.create_lattice(lattice.sc(a=3.7411019268182444), n=[20, 20, 25])
        # target a packing fraction of 0.01
    ...
    def test_aniso(self):
        ...
        gb.pair_coeff.set("A", "A", epsilon=1.0, lperp=0.45, lpar=0.25)
