    ...
    def setUp(self):
        ...
        if comm.get_rank() == 0:
            ...
            snapshot.particles.orientation[1] = (
                math.cos(0.5 * angle_deg * math.pi / 180),
                0,
                0,
                math.sin(0.5 * angle_deg * math.pi / 180),
            )
        ...
        self.rigid.set_param("A", positions=[(-0.5, 0, 0), (0.5, 0, 0)], types=["sphere"] * 2)
        self.rigid.set_param("B", positions=[(-0.5, 0, 0), (0.5, 0, 0)], types=["sphere"] * 2)
