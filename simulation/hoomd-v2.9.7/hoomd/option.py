...
def _parse_command_line(arg_string=None):
    ...
    parser.add_option(
        ...
        action="store_true",
        default=False,
        help="Enable to keep the CPU usage of HOOMD to a bare minimum (will degrade overall performance somewhat)",
    )
    parser.add_option(
        "--ignore-display-gpu",
        dest="ignore_display",
    ...
    parser.add_option(
        ...
        help="(MPI only) Name of shared file to write message to (append partition #)",
    )
